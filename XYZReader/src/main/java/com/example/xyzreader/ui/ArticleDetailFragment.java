...
public class ArticleDetailFragment extends Fragment implements  LoaderManager.LoaderCallbacks<Cursor>
{
    ...
    public void onAttach(Activity activity) {
        ...
        Typeface courgette = Typeface.createFromAsset(getActivity().getAssets(), "Courgette-Regular.ttf");
    }
    ...
    private void bindViews()
    {
        ...
        //titleView.setTypeface(courgette);
        ...
        if (mCursor != null)
        {
            ...
            bodyView.setText(Html.fromHtml(mCursor.getString(ArticleLoader.Query.BODY).substring(0,4000).replaceAll("(\r\n\r\n)", "<br/><br/>")).toString());
